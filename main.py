...
async def update_castle(
    payload: Dict[str, Any] = Body(...), current_user: User = Depends(get_current_user)
):
    ...
    castle["last_updated_by"] = username
...
async def download_map_image():
    print(
        "Received download_map_image request"
    )  # Placeholder: print the information sent
...
async def auto_place_castles():
    print(
        "Received auto_place_castles request"
    )  # Placeholder: print the information sent
...
async def upload_csv(csv_file: UploadFile = File(...)):
    print(
        f"Received upload_csv: file={csv_file.filename}"
    )  # Placeholder: print the information sent
...
async def register(
    ...
    """
    return create_user(username, password, full_name)
